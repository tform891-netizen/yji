  ...
  return (
    <div>
      <PageHeader
        ...
        description="Gestion des postes et fonctions du personnel"
        action={canCreate && (
      ...
      <Card className="p-4">
        <div className="flex gap-3 mb-4">
          <div className="relative flex-1">
            ...
            <Input placeholder="Rechercher par nom, code ou catégorie..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-9" />
          </div>
        </div>
...
function PositionFormDialog({
  open, onOpenChange, position, institutionId, onSaved,
}: {
  open: boolean;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Définissez un poste ou une fonction.</DialogDescription>
        </DialogHeader>
